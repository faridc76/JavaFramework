...
import io.mincong.math.Matrix;
import io.mincong.math.MatrixHelper;
import io.mincong.math.Vector;
...
public class MatrixPowermockTest {
    ...
    public void testBuildMatrix() {
        ...
        Mockito.when(MatrixHelper.buildMatrix(
                Mockito.any(Vector.class),
                Mockito.any(Vector.class),
                Mockito.any(Vector.class)
        )).thenReturn(new Matrix(v1, v2, v3));
